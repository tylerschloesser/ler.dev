...
export class DnsStack extends Stack {
  ...
  constructor(
    ...
    this.zones = {
      ...
      [DomainName.DrawApiStagingTyLerDev]:
        new PublicHostedZone(
          this,
    ...
    invariant(
      this.zones[DomainName.StagingTyLerDev]
    ...
    invariant(
      this.zones[DomainName.DrawApiTyLerDev]
        .hostedZoneNameServers,
    )
    ...
    invariant(
      this.zones[DomainName.DrawApiStagingTyLerDev]
        .hostedZoneNameServers,
    )
